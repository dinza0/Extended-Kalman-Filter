...
def main_loop():
    ...
    while True:
       ...
       # sensor_data = read_bno085(sensor)
        ...
        #z_gyro = np.array([0.0, 0.0, 1.0])  # 1 rad/s about the body Z‐axis
        #z_mag = enu2body(q, m_ref)
